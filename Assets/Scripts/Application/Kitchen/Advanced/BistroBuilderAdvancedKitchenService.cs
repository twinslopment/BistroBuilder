...
/// <summary>
/// Orquestador del Bloque 12. Reparte lÃ­neas canÃ³nicas entre estaciones,
...
public sealed class BistroBuilderAdvancedKitchenService : MonoBehaviour
{
    ...
    public bool TryRebuildStationConfiguration(out string error)
    {
        ...
        {
            error = "No puede reconstruirse la configuraciÃ³n de estaciones con preparaciones activas.";
            return false;
        }
    ...
    public bool ValidateConfiguration(out string error)
    {
        ...
        {
            error = "12 necesita KitchenSystem, ejecuciÃ³n de lÃ­neas, comandas, estaciones y Personal.";
            return false;
        }
        ...
        {
            error = "El tiempo de reparaciÃ³n de cocina es invÃ¡lido.";
            return false;
        }
        error = string.Empty;
        return true;
        ...
        out string error)
    {
        ...
        {
            error = "La lÃ­nea no puede entrar en la cocina avanzada.";
            return false;
        }
        ...
        for (int i = 0; i < route.Count; i++)
        {
            ...
            error = "La ruta referencia una estaciÃ³n no instalada: " + route[i] + ".";
            return false;
        }
        ...
        out string error)
    {
        ...
        {
            error = "Modo de entrada de cocina invÃ¡lido.";
            return false;
        }
        intakeMode = mode;
        Changed?.Invoke();
        ...
        out string error)
    {
        ...
        {
            error = "EstaciÃ³n o incidencia invÃ¡lida.";
            return false;
        }
        ...
        out string error)
    {
        ...
        for (int i = 0; i < snapshot.workItems.Count; i++)
        {
            ...
            {
                error = "La ruta del plato cambiÃ³ desde el guardado.";
                ClearRuntimeForLoad();
                return false;
            }
            var work = new WorkItem(
        ...
        // Interaction restaura su snapshot despuÃ©s de service.runtime. Los
        // permits derivados se reconstruyen en su Reconciliation Barrier,
        // nunca aquÃ­, para que no sean borrados por el reset posterior.
        RecalculateLoad();
        Changed?.Invoke();
        error = string.Empty;
        return true;
        ...
        WorkItem work)
    {
        ...
        if (kind == BistroBuilderKitchenIncidentKind.EquipmentFailure)
        {
            ...
            message = station.Definition.displayName +
                      " queda temporalmente bloqueada por una averÃ­a.";
        }
        else if (kind == BistroBuilderKitchenIncidentKind.Slowdown)
        {
            ...
            message = station.Definition.displayName +
                      " trabaja temporalmente mÃ¡s despacio.";
        }
        else
        {
