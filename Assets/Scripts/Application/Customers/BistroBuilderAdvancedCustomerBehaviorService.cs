...
public sealed class BistroBuilderAdvancedCustomerBehaviorService : MonoBehaviour
{
        ...
        out string error)
    {
        ...
        bool hasVisit = trackingService.TryGetRuntimeVisit(group.GroupId, out var visit);
        bool hasProfile = profileService.TryGetGroupProfile(group.GroupId, out var profile);
