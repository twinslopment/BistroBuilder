...
public sealed class TableCleaningAssignmentSystem : MonoBehaviour
{
    ...
    private void TryDispatchCleaningTasks()
    {
        int tableIndex = 0;
        ...
        while (tableIndex < waitingTables.Count)
        {
            ...
            {
                Debug.Log(
                    $"No hay camareros libres para limpiar " +
            ...
            bool assigned =
                closestWaiter.AssignTableForCleaning(table);
            ...
            Debug.Log(
                $"Limpieza de la mesa {table.TableId} asignada " +
    ...
    private void ValidateConfiguration()
    {
        ...
        {
            Debug.LogError(
                "TableCleaningAssignmentSystem no tiene mesas configuradas.",
                this
            );
        }
        ...
        {
            Debug.LogError(
                "TableCleaningAssignmentSystem no tiene camareros configurados.",
                this
            );
        }
    }
