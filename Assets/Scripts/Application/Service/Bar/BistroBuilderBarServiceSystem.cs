...
public sealed class BistroBuilderBarServiceSystem : MonoBehaviour
{
    ...
    /// <summary>
    /// Entrada pÃºblica del Bloque 14 para ofrecer barra temporal a un grupo
    /// que originalmente solicitÃ³ mesa. No altera su modalidad solicitada.
    /// </summary>
    public bool TryOfferWaitingAtBar(CustomerGroup group, out string error)
    {
        ...
        Log("Bloque 14 enviÃ³ manualmente el grupo " + group.GroupId +
