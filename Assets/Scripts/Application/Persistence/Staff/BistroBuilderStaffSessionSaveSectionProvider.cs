...
/// - Apply 450: después de staff.state (400) y antes de service.runtime (500).
    ...
    IBistroBuilderSaveSectionPhaseOrdering
{
    ...
    public void FinalizeLoad(BistroBuilderSaveLoadContext context)
    {
        ...
        if (!sectionWasLoaded)
        {
            ...
            // cualquier sesión de la partida que estaba abierta antes del
            // Load y se reconstruye una sesión nueva solo si el save antiguo
            // declara un servicio activo.
