    ...
    IBistroBuilderSaveSectionPhaseOrdering
{
    ...
    // Employee debe existir antes de restaurar EmployeeId ↔ WaiterId (450) y
    // antes de que service.runtime reconstruya el mundo operativo (500).
    ...
    public IEnumerator PrepareForLoad(BistroBuilderSaveLoadContext context)
    {
        ...
        // accidente la plantilla de la partida que estaba abierta antes.
