...
[InitializeOnLoad]
public static class BistroBuilderAdvancedOrders11SaveLoadPlayModeSelfTest
{
    private const string ScenePath = "Assets/Scenes/Prototype_Restaurant.unity";
    private const string StageKey = "BB.Orders11.SaveLoad.Stage";
    private const string SuccessKey = "BB.Orders11.SaveLoad.Success";
    private const string ReportPath = "AdvancedOrders11SaveLoadReport.txt";
    ...
    static BistroBuilderAdvancedOrders11SaveLoadPlayModeSelfTest()
    {
    ...
    [MenuItem("Tools/Bistro Builder/Orders/11 - SaveLoad real", false, 9104)]
    ...
    private static void Begin(bool cli)
    {
        if (EditorApplication.isPlayingOrWillChangePlaymode)
            throw new InvalidOperationException("El Save/Load 11 ya está ejecutándose.");
    ...
    private static void OnUpdate()
    {
        ...
        if (stage.StartsWith("run_", StringComparison.Ordinal))
        {
            ...
            {
                Finish(false, "No pudo iniciar el Save/Load real 11: " + Unwrap(exception).Message, cli);
            }
            return;
        }
        ...
        {
            Finish(false, "Timeout del Save/Load real 11.", commandLine);
            return;
        }
        ...
        {
            Finish(false, "Excepción en Save/Load real 11: " + Unwrap(exception).Message, commandLine);
        }
    }
    ...
    {
        string report = "=== BISTRO BUILDER — BLOQUE 11 / SAVE-LOAD REAL ===\n" +
