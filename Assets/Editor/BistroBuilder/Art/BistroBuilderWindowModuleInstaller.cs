...
public static class BistroBuilderWindowModuleInstaller
{
    private const string AssetName = "BB_WindowModule_1200x2500_A";
    ...
    [MenuItem("Tools/Bistro Builder/Art/Install Window Module 1200x2500 A")]
    ...
    private static void BuildPrefab(Material frameMaterial, Material glassMaterial)
    {
        ...
        collider.size = new Vector3(1.20f, 2.50f, 0.10f);
