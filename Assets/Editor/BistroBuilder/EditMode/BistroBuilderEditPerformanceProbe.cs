...
public static class BistroBuilderEditPerformanceProbe
{
    ...
    private static int stage, slot, lastFrame, frames, revisionBefore, healthBefore, obstaclesBefore;
        ...
        try
        {
            ...
            switch (stage)
            {
                case 0:
                    ...
                    report.fullHealthMs = label == "baseline"
                        ? Measure(() => navigation.EvaluateCirculationHealth()) : -1;
                ...
                case 1:
                    ...
                    obstaclesBefore = navigation.StaticObstacleCount;
                ...
                case 2:
                    ...
                    Check(report.deleteTopologyBuilds > 0, "Deletion did not update navigation geometry");
                    Check(navigation.StaticObstacleCount == obstaclesBefore - 1, "Deleted chair still blocks navigation");
                ...
                case 4:
                    ...
                    Check(navigation.StaticObstacleCount == obstaclesBefore, "Loaded chair did not restore its navigation obstacle");
